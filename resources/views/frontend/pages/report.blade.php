                    ...
                    <div class="col-lg-6">
                        <div class="border-0">
                            <div class="card-body  pr-lg-0 pl-xl-13 ">
                                <h2 class="card-title fs-30 font-weight-600 text-dark lh-16 mb-2 text-center">Report Issus</h2>
                                <form class="form" method="POST" action="{{ route('addReport') }}">
                                    @csrf
                                    ...
                                    <div class="form-row mx-n2">
                                        <div class="col-sm-12 px-2">
                                            <div class="form-group">
                                                <label for="password-1" class="text-heading"><b>Subject</b></label>
                                                <div class="input-group input-group-lg">
                                                    <input type="text"
                                                        class="form-control border-1 @error('subject') is-invalid @enderror"
                                                        name="subject"
                                                        placeholder="Subject">
                                                    @error('subject')
                                                        <span class="invalid-feedback" role="alert">
                                        ...
                                        <div class="col-sm-12 px-2">
                                            <div class="form-group">
                                                <label for="re-password" class="text-heading"><b>Message</b></label>
                                                <div class="input-group input-group-lg">
                                                    <textarea  class="form-control border-1" name="message" style="width:100%"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
