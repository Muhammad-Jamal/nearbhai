                                                ...
                                                <div class="card-body p-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            id="name" name="name" value="{{ $work->name }}">
                                                    </div>
                                                    @error('name')
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text"
                                                            class="form-control form-control-lg border-0"
                                                            id="email" name="email" value="{{ $work->email }}">
                                                    </div>
                                                    @error('email')
                                                    <strong class="text-danger">
                                                        {{ $message }}
                                                    ...
                                                    <br>
                                                    <div class="form-group">
                                                        <label for="budget" class="text-heading">Budget<span
                                                                class="text-muted"></span></label>
                                                        <input type="text"
                                                            class="form-control form-control-lg border-0"
                                                    ...
                                                    <div class="mt-4 form-group mb-0 text-center">
                                                        <input type="submit" name="submit" value="Update Work" class="btn btn-lg btn-primary">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
